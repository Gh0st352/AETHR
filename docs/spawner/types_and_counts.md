...
- Seeding and resolution
  - [AETHR.SPAWNER:seedTypes()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1804)
  - [AETHR.SPAWNER:_resolveTypesForAttribute()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1748)
  - [AETHR.SPAWNER:_toSpawnAttr()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1712)
  - [AETHR.SPAWNER:_attrToEnumKey()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1721)
- Group type generation
  - [AETHR.SPAWNER:generateGroupTypes()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1600)
  - [AETHR.SPAWNER:rollSpawnGroups()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1588)
- Counts and balancing
  - [AETHR.SPAWNER:generateSpawnAmounts()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1918)
  - [AETHR.SPAWNER:rollSpawnGroupSizes()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1876)
  - [AETHR.SPAWNER:_Jiggle()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1978)
  - [AETHR.SPAWNER:_RollUpdates()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L2002)
...
### Resolution strategy in [AETHR.SPAWNER:_resolveTypesForAttribute()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1748):
...
### Helpers:
- [AETHR.SPAWNER:_toSpawnAttr()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1712) maps enum key or display string to canonical attribute.
- [AETHR.SPAWNER:_attrToEnumKey()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1721) caches reverse mapping to enum key for priority ordering.
...
- [AETHR.SPAWNER:rollSpawnGroupSizes()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1876) converts each subzone’s generated count into discrete groups at sizes listed in groupSizesPrio, greedily filling larger sizes first.
...
- Deterministic execution: if enabled with a seed, all random draws in the outer pipeline run under [AETHR.UTILS:withSeed()](https://github.com/Gh0st352/AETHR/blob/main/dev/UTILS.lua#L242), ensuring repeatable group typing and counts for the same seed.

# 6. Additional logic diagrams

## 6.1 Attribute resolution flow for [AETHR.SPAWNER:_resolveTypesForAttribute()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1748)
...
### Notes
- Priority ordering uses reverse map from attribute name to enum key via [AETHR.SPAWNER:_attrToEnumKey()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1721).

## 6.2 rollSpawnGroups wrapper [AETHR.SPAWNER:rollSpawnGroups()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1588)
...
## 6.3 Group size allocation flow [AETHR.SPAWNER:rollSpawnGroupSizes()](https://github.com/Gh0st352/AETHR/blob/main/dev/SPAWNER.lua#L1876)
...
# Determinism note
- When deterministic mode is enabled, upstream random draws for typing and counts execute under [AETHR.UTILS:withSeed()](https://github.com/Gh0st352/AETHR/blob/main/dev/UTILS.lua#L242), as documented in [pipeline.md](./pipeline.md).
